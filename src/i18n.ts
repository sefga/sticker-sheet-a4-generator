...
export const translations = {
  ru: {
    ...
    paperCatalogSubtitle: '15 предустановленных стандартов для офисных, термо- и фотопринтеров',
  ...
  en: {
    ...
    paperCatalogSubtitle: '15 presets for office, thermal, label and photo printers',
